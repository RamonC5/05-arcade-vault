    ...
    <div className="av-hall fade-in">
      ...
      <div className="podium">
        ...
        <div className="podium-slot gold">
          <div
            className="pixel"
            style={{ fontSize: 9, color: "var(--color-av-gold)", letterSpacing: "0.18em" }}
          >
            CAMPEÓN
          </div>
        ...
        {user && (
          <>
            ...
            <div className="tr you" style={{ animationDelay: `${rows.length * 50 + 50}ms` }}>
              <div className="rk" style={{ color: "var(--color-av-yellow)" }}>
                #{String(youRank).padStart(2, "0")}
              </div>
              <div className="pl" style={{ color: "var(--color-av-yellow)" }}>
                {user.name}
              </div>
              <div
                className="sc"
                style={{ color: "var(--color-av-yellow)", textShadow: "0 0 6px rgba(245,255,0,0.5)" }}
              >
